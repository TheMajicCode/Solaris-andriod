#!/usr/bin/env python3
"""Sign candidate 604 only after the caller supplies a hash-bound gate and two independent reviews.
...
BASELINE_SHA = '25d3642ab5f45986e5dfcfe5c5413d40982c6142eb703adffc391f9d3b033227'
...
VERSION = '6.0.4-preview.grounded-chat'
...
def main():
    ...
    require(gate['format'] == 'solaris-v6-604-signing-gate/1' and gate['decision'] == 'approve-signing',
            'GATE_DECISION')
    require(gate['baselineApkSha256'] == BASELINE_SHA and digest(args.baseline) == BASELINE_SHA,
            'GATE_BASELINE')
    require(gate['packageId'] == PACKAGE and gate['versionCode'] == 604 and gate['versionName'] == VERSION,
            'GATE_IDENTITY')
    ...
    candidate = args.output_dir / 'Solaris-V6.0.4-Grounded-Chat-Candidate.apk'
    ...
    report.update({'format': 'solaris-v6-604-signed-candidate-result/1', 'signingPerformedByThisTool': True,
