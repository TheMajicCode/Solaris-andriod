...
BASELINE_APK = '25d3642ab5f45986e5dfcfe5c5413d40982c6142eb703adffc391f9d3b033227'
BASELINE_HBC = 'b8ac7d1b58d9e8ea6eadd25de516e35842aea14e4b849462664bb3200fedc990'
BASELINE_MANIFEST = 'f906d8709e4eecdd850d3acc33d565e50b0d296abf235598a3e15e5f3bd4c20c'
CERTIFICATE = 'fac61745dc0903786fb9ede62a962b399f7348f0bb6f899b8332667591033b9c'
PACKAGE = 'org.solarishealth.edge.recovery'
OLD_VERSION, VERSION = '6.0.3-preview.pocket-chat', '6.0.4-preview.grounded-chat'
OLD_CODE, CODE = 603, 604
...
def read_build_manifest(path, hbc):
    ...
    require(build['format'] == 'solaris-v6-604-build-manifest/1', 'BUILD_MANIFEST_FORMAT')
...
def main():
    ...
    with zipfile.ZipFile(args.baseline) as source:
        ...
        (evidence / 'AndroidManifest-604.xml').write_bytes(manifest)
    ...
    report = {'format': 'solaris-v6-604-unsigned-packaging-or-verification/1',
