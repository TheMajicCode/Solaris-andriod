...
def main():
    ...
    config = acquire('build.gradle', CONFIG_HASH).decode('utf-8')
    ...
    report = {'format': 'solaris-v6-602-fixture-readiness/1', 'officialCommit': COMMIT,
              ...
              'localRestrictedFixturePath': str(location), 'fixtureFileMode': oct(location.stat().st_mode & 0o777),
              ...
              'credentialsLoggedOrPersisted': False, **verified}
