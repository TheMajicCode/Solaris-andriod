#!/usr/bin/env python3
"""Bounded HBC96 function-body patching for the exact Solaris603 reference.
...
BASE_SHA256 = 'b8ac7d1b58d9e8ea6eadd25de516e35842aea14e4b849462664bb3200fedc990'
BASE_LENGTH = 30754484
...
def read(data, exact_base=False):
    ...
    if exact_base:
        require(len(data) == BASE_LENGTH and digest(data) == BASE_SHA256, 'Not exact verified603 input')
    r = HBCReader()
