...
### Sprint-02 re-measurement — 25 September 2026
...
| A605 candidate host bundle | **Built** from the bounded donor through the same path: `d0e36d6e…`, 30,816,156 bytes (revised twice after independent review; earlier revisions were `611a2430…` and `105ade31…`). Host 34/34, lifecycle 10/10. See [bounded donor proof](HOST-REPRODUCTION-EVIDENCE.md#bounded-donor-proof). |
...
the exact 603 APK `25d3642a…`, together with the three pinned packaging tools. With
those, an A605 packaging rehearsal could run in a disposable copy under a separate
authorization. Nothing in this sprint builds, signs or installs an APK.
