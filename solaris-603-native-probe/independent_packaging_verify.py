...
with zipfile.ZipFile(base) as a,zipfile.ZipFile(candidate) as b:
 ...
 check('final reviewed HBC',sha(b.read('assets/index.android.bundle'))=='b8ac7d1b58d9e8ea6eadd25de516e35842aea14e4b849462664bb3200fedc990')
...
report={'reviewer':'native_chat_repro independent packaging review','candidate':str(candidate),'candidateSha256':h(candidate),'candidateBytes':candidate.stat().st_size,'baselineSha256':h(base),'hbcSha256':'b8ac7d1b58d9e8ea6eadd25de516e35842aea14e4b849462664bb3200fedc990','signedVerified':signed,'checksPassed':len(checks),'checks':checks,'changed':changed,'native':native,'commands':commands}
