 ...
 * is removed. Exact SDK0.18.2 accepts responseFormat.schema as an object.
 */
function conversationRequest(request, isConversation) {
  ...
  format.name = String.fromCharCode(115, 111, 108, 97, 114, 105, 115, 95, 99, 111, 110, 118) + String.fromCharCode(101, 114, 115, 97, 116, 105, 111, 110);
